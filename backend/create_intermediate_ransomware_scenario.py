...
def get_artifact_content(filename: str) -> str:
    ...
    with tempfile.TemporaryDirectory() as tmpdir:
        # Temporarily change ARTIFACTS_DIR to temp directory
        ...
        try:
            ...
            # Run the appropriate generation function based on filename
            ...
            if file_path.exists():
                ...
                available = list(Path(tmpdir).glob("*.txt"))
                print(f"Warning: Generated file not found: {filename}")
                print(f"Available files: {[f.name for f in available]}")
                return f"[Artifact content generation failed: {filename}]"
        finally:
...
try:
    ...
    hr_recon = Artifact(
        ...
        file_url=None,  # Content stored in database, no file URL needed
        content=get_artifact_content("hr_recon_phase1.txt"),
    ...
    ops_recon = Artifact(
        ...
        file_url=None,
        content=get_artifact_content("ops_recon_phase1.txt"),
    ...
    c2_status = Artifact(
        ...
        file_url=None,
        content=get_artifact_content("c2_status_phase1.txt"),
    ...
    hr_defender = Artifact(
        ...
        file_url=None,
        content=get_artifact_content("defender_hr_alert_phase1.txt"),
    ...
    ops_defender = Artifact(
        ...
        file_url=None,
        content=get_artifact_content("defender_ops_alert_phase1.txt"),
    ...
    sentinel_phishing = Artifact(
        ...
        file_url=None,
        content=get_artifact_content("sentinel_phishing_phase1.txt"),
    ...
    network_mapping = Artifact(
        ...
        file_url=None,  # Content stored in database
        content=get_artifact_content("network_mapping_phase4.txt"),
    ...
    access_test = Artifact(
        ...
        file_url=None,  # Content stored in database
        content=get_artifact_content("access_test_phase4.txt"),
    ...
    db_access_logs = Artifact(
        ...
        file_url=None,  # Content stored in database
        content=get_artifact_content("db_access_logs_phase4.txt"),
    ...
    network_seg = Artifact(
        ...
        file_url=None,  # Content stored in database
        content=get_artifact_content("network_seg_phase4.txt"),
